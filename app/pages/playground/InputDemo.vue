    ...
    <div class="max-w-4xl mx-auto space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="grid w-full max-w-sm items-center gap-1.5">
          ...
          <Input id="basic" type="text" placeholder="Enter text here..." />
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <div class="grid w-full items-center gap-1.5">
            ...
            <Input id="disabled" type="text" v-model="disabledValue" disabled />
          </div>
          <div class="grid w-full items-center gap-1.5">
          ...
          <div class="grid w-full items-center gap-1.5">
            <Label for="error">With Error</Label>
            <Input
              id="error"
              type="text"
      ...
      <div class="space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <div class="grid w-full items-center gap-1.5">
            <Label for="search-icon">Search with Icon</Label>
            <div class="relative">
              <svg
      ...
      <!-- File Input -->
      <div class="space-y-4">
        <h2 class="text-2xl font-semibold">File Input</h2>
        <div class="grid w-full max-w-sm items-center gap-1.5">
      ...
      <!-- Input Sizes -->
      <div class="space-y-4">
        <h2 class="text-2xl font-semibold">Input Sizes</h2>
        <div class="space-y-3">
          <div class="grid w-full max-w-sm items-center gap-1.5">
      ...
      <!-- Input with Button -->
      <div class="space-y-4">
        <h2 class="text-2xl font-semibold">Input with Button</h2>
